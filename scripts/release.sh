...
case "$CURRENT_VERSION:$MODE" in
  1.0.0:minor|1.1.0:patch|1.1.1:patch|1.1.2:patch|1.1.3:patch|1.1.4:patch|1.1.5:patch|1.1.6:patch) ;;
  *)
    echo "Bridge releases are limited to v1.1.0 through v1.1.7; v1.1.7 fixes FAT-safe Unraid boot replay." >&2
    exit 1
    ;;
esac
